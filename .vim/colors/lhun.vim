...
" Grey
let s:grey_dark0   = ['#121212', 233]
let s:grey_dark1   = ['#1C1C1C', 234]
let s:grey_dark2   = ['#303030', 236]
let s:grey_med0    = ['#444444', 238]
let s:grey_med1    = ['#4E4E4E', 239]
