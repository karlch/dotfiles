...
let g:colors_name='lhun_pastell'
...
if exists("g:lhun_flavour")
  ...
  let s:main_med    = g:lhun_flavour[1]
...
call s:HL('Todo', s:grey_dark0, s:red, s:bold)
call s:HL('Type', s:extra1)
call s:HL('Underline', s:grey_light, s:none, s:underline)
call s:HL('Visual', s:grey_dark0, s:main_med)
