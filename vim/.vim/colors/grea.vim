...
hi DiffAdd		ctermfg=234	ctermbg=34	cterm=none
...
hi Special		ctermfg=34	ctermbg=none	cterm=none
hi Statement	        ctermfg=46	ctermbg=none	cterm=none
hi StatusLine 	        ctermfg=34	ctermbg=236	cterm=bold
...
hi TablineSel           ctermfg=34      ctermbg=236     cterm=none
hi TablineFill          ctermfg=34      ctermbg=none     cterm=none
...
hi Wildmenu		ctermfg=46	ctermbg=none	cterm=bold
hi EasyMotionTarget     ctermfg=46      ctermbg=none    cterm=none
hi EasyMotionShade      ctermfg=239     ctermbg=none    cterm=none
hi EasyMotionTarget2First ctermfg=46    ctermbg=none    cterm=none
hi EasyMotionTarget2Second ctermfg=34   ctermbg=none    cterm=none
hi Conceal		ctermfg=34	ctermbg=none	cterm=none
