...
syn keyword cAnsiFunction	snprintf scanf
syn keyword Output              printf
...
syn match cOperator     "&&\|||"
syn match cOperator	"[][]"
syn match cCompOperator "\(==\|<=\|>=\|<\|>\|&&\|||\)"
hi! link cCompOperator  CompOperator
"
"" Preprocs
syn keyword cDefined defined contained containedin=cDefine
hi! link cDefined cDefine

"" Functions
syn match cUserFunction "\<\h\w*\>\(\s\|\n\)*("me=e-1 contains=cType,cDelimiter,cDefine
syn match cUserFunctionPointer "(\s*\*\s*\h\w*\s*)\(\s\|\n\)*(" contains=cDelimiter,cOperator
"
hi! link cUserFunction cFunction
hi! link cUserFunctionPointer cFunction
"
"" Delimiters
